...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('settings.index')->with('success', 'Gym settings updated successfully.');
    }
    ...
    public function restoreBackup(Request $request)
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE || !isset($data['meta'], $data['members'])) {
            return back()->with('error', 'Invalid backup file. Please upload a valid WarmUp backup.');
        }

        // Check meta signature
        if (!isset($data['meta']['app']) || $data['meta']['app'] !== 'WarmUp Gym Management') {
            return back()->with('error', 'Unrecognised backup format. This file was not generated by WarmUp.');
        }
        ...
        return redirect()->route('settings.index')
            ->with('success', 'Backup restored successfully. All data has been updated.');
    }
}
