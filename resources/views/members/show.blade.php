...
@section('meta_description', 'View member profile, memberships, and payment history.')
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
                ...
                <div class="w-full mt-6 pt-6 border-t border-gray-100 flex justify-around text-center">
                    <div>
                        <p class="text-xs font-medium" style="color:#9CA3AF;">Joined</p>
                        <p class="text-sm font-semibold mt-0.5" style="color:#374151;">{{ $member->joining_date->format('d M Y') }}</p>
                    </div>
                    <div>
                        <p class="text-xs font-medium" style="color:#9CA3AF;">Gender</p>
                        <p class="text-sm font-semibold mt-0.5 capitalize" style="color:#374151;">{{ $member->gender }}</p>
                    </div>
                    @if($member->date_of_birth)
                    <div>
                        <p class="text-xs font-medium" style="color:#9CA3AF;">Age</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
                <h3 class="text-sm font-semibold uppercase tracking-wider" style="color:#9CA3AF;">Contact Info</h3>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs" style="color:#6B7280;">Mobile</p>
                    </div>
                </div>
                ...
                <div class="pt-4 border-t border-gray-100">
                    <h3 class="text-sm font-semibold uppercase tracking-wider mb-3" style="color:#9CA3AF;">Emergency Contact</h3>
                ...
                <div class="pt-4 border-t border-gray-100">
                    <h3 class="text-sm font-semibold uppercase tracking-wider mb-3" style="color:#9CA3AF;">Medical Info</h3>
                    <div class="grid grid-cols-2 gap-y-2 gap-x-4 text-sm mb-3">
                        @if($member->blood_group)
                            <div style="color:#6B7280;">Blood: <span class="font-medium" style="color:#374151;">{{ $member->blood_group }}</span></div>
                        @endif
                        @if($member->height)
                            <div style="color:#6B7280;">Height: <span class="font-medium" style="color:#374151;">{{ $member->height }}cm</span></div>
                        @endif
                        @if($member->weight)
                            <div style="color:#6B7280;">Weight: <span class="font-medium" style="color:#374151;">{{ $member->weight }}kg</span></div>
                        @endif
                    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between" style="background-color:#F8FAFC;">
                    ...
                    @if(!$activeMembership)
                        <button type="button" onclick="document.getElementById('assign-modal').classList.remove('hidden')"
                            ...
                            <i data-lucide="plus" class="w-3.5 h-3.5"></i> Assign Plan
                        </button>
                    @else
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-sm font-medium" style="color:#374151;">No active membership</p>
                            <p class="text-sm mt-1" style="color:#6B7280;">This member currently does not have an active plan.</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="text-base font-semibold" style="color:#111827;">Membership History</h3>
                </div>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 text-xs uppercase tracking-wider" style="color:#9CA3AF;">
                            <tr>
                                ...
                                <th class="px-6 py-3 font-medium text-right">Paid / Total</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-3 font-medium" style="color:#374151;">
                                    {{ $mem->membershipPlan->name ?? 'Unknown Plan' }}
                                    @if($mem->remaining_amount > 0)
                                        <span class="ml-2 px-2 py-0.5 text-[10px] font-bold rounded bg-red-100 text-red-700">Due: {{ number_format($mem->remaining_amount,0) }}</span>
                                    @endif
                                </td>
                                <td class="px-6 py-3" style="color:#6B7280;">
                                    {{ $mem->start_date->format('d M Y') }} — {{ $mem->end_date->format('d M Y') }}
                                </td>
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="px-6 py-8 text-center text-sm" style="color:#9CA3AF;">No membership history available.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                @if($allPayments->isEmpty())
                    <div class="px-6 py-8 text-center text-sm" style="color:#9CA3AF;">No payments recorded yet.</div>
                @else
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 text-xs uppercase tracking-wider" style="color:#9CA3AF;">
                        ...
                        <tfoot class="border-t-2 border-gray-200 bg-gray-50">
                            <tr>
                                <td colspan="3" class="px-6 py-3 text-sm font-semibold" style="color:#374151;">Total Paid</td>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="{{ route('attendances.index', ['view' => 'monthly', 'search' => $member->phone]) }}" class="text-sm font-medium" style="color:#22C55E;">View All</a>
                </div>
                @php
                    $recentAttendances = $member->attendances()->orderByDesc('date')->take(5)->get();
                @endphp
                @if($recentAttendances->isEmpty())
                    <div class="px-6 py-8 text-center text-sm" style="color:#9CA3AF;">No check-in history found.</div>
                @else
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 text-xs uppercase tracking-wider" style="color:#9CA3AF;">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-3" style="color:#6B7280;">
                                    {{ ($attendance->status === 'present' && $attendance->check_in_time) ? \Carbon\Carbon::parse($attendance->check_in_time)->format('h:i A') : '—' }}
                                </td>
                                <td class="px-6 py-3" style="color:#6B7280;">
                                    {{ ($attendance->status === 'present' && $attendance->check_out_time) ? \Carbon\Carbon::parse($attendance->check_out_time)->format('h:i A') : '—' }}
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<div id="assign-modal" class="hidden fixed inset-0 z-50 overflow-y-auto bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-lg font-bold" style="color:#111827;">Assign Membership Plan</h3>
        ...
        <form action="{{ route('members.assign-membership', $member) }}" method="POST" class="p-6 space-y-4">
            @csrf
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Select Plan <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Start Date <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Initial Payment (Optional)</label>
                <input type="number" name="paid_amount" min="0" step="0.01" value="0"
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white" style="color:#374151;">
                <p class="text-xs mt-1" style="color:#6B7280;">Leave 0 to record payment later.</p>
            </div>
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Notes (Optional)</label>
...
<div id="renew-modal" class="hidden fixed inset-0 z-50 overflow-y-auto bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-lg font-bold" style="color:#111827;">Renew Membership</h3>
        ...
        <form action="{{ route('members.renew-membership', $member) }}" method="POST" class="p-6 space-y-4">
            ...
            <div class="p-3 rounded-xl text-xs" style="background-color:#F0FDF4; color:#15803D; border:1px solid #BBF7D0;">
                <strong>Current:</strong> {{ $activeMembership->membershipPlan->name }} — ends {{ $activeMembership->end_date->format('d M Y') }}
            </div>
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Select New Plan <span class="text-red-500">*</span></label>
                <select name="membership_plan_id" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white" style="color:#374151;">
                    <option value="">— Choose Plan —</option>
                    @foreach($activePlans as $plan)
            ...
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">New Start Date <span class="text-red-500">*</span></label>
                <input type="date" name="start_date" 
                       value="{{ max(now(), $activeMembership->end_date->copy()->addDay())->format('Y-m-d') }}" 
                       required
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white" style="color:#374151;">
                <p class="text-xs mt-1" style="color:#6B7280;">Defaults to day after current plan ends.</p>
            </div>
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Payment Now (Optional)</label>
                <input type="number" name="paid_amount" min="0" step="0.01" value="0"
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white" style="color:#374151;">
                <p class="text-xs mt-1" style="color:#6B7280;">Leave 0 to record payment later.</p>
            </div>
...
<div id="payment-modal" class="hidden fixed inset-0 z-50 overflow-y-auto bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-lg font-bold" style="color:#111827;">Record Payment</h3>
        ...
        <form action="{{ route('members.record-payment', $member) }}" method="POST" class="p-6 space-y-4">
            ...
            <div class="p-3 rounded-xl text-sm font-medium flex items-center gap-2"
                ...
                Remaining Balance: <strong>{{ number_format($activeMembership->remaining_amount, 2) }}</strong>
            </div>

            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Amount Paid <span class="text-red-500">*</span></label>
                <input type="number" name="amount_paid"
                       ...
                       required
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white" style="color:#374151;">
                <p class="text-xs mt-1" style="color:#6B7280;">Maximum: {{ number_format($activeMembership->remaining_amount, 2) }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Payment Date <span class="text-red-500">*</span></label>
                <input type="date" name="payment_date" value="{{ now()->format('Y-m-d') }}" required
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white" style="color:#374151;">
            </div>
            <div>
                <label class="block text-sm font-medium mb-1.5" style="color:#374151;">Payment Method <span class="text-red-500">*</span></label>
