...
@section('page_title', 'Member Report')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form method="GET" action="{{ route('reports.members') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('reports.members') }}" class="flex-1 px-4 py-2 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-colors text-sm font-medium text-center">Reset</a>
            </div>
        </form>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <h3 class="text-lg font-bold text-gray-900">Member List</h3>
