...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-gray-900">{{ __('Reports Dashboard') }}</h2>
        <p class="mt-1 text-sm text-gray-500">{{ __('Access and export comprehensive data across all modules.') }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('reports.revenue') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-green-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-green-600 transition-colors">{{ __('Revenue Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('View total revenue generated from fee collections, categorized by time periods.') }}</p>
                <div class="mt-4 flex items-center text-sm font-medium text-green-600">
                    {{ __('View Report') }} <i data-lucide="arrow-right" class="w-4 h-4 ml-1"></i>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('reports.attendance') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-blue-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">{{ __('Attendance Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('Track member check-ins and check-outs, view present and absent counts.') }}</p>
        ...
        <a href="{{ route('reports.members') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-purple-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-purple-600 transition-colors">{{ __('Member Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('Comprehensive list of all members with joining dates, statuses, and assigned trainers.') }}</p>
        ...
        <a href="{{ route('reports.memberships') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-orange-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-orange-600 transition-colors">{{ __('Membership Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('Analyze active, expired, and upcoming memberships across different plans.') }}</p>
        ...
        <a href="{{ route('reports.trainers') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-indigo-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors">{{ __('Trainer Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('Overview of trainers, their specializations, statuses, and assigned members.') }}</p>
        ...
        <a href="{{ route('reports.fees') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-teal-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-teal-600 transition-colors">{{ __('Fee Collection Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('Detailed history of all fee payments received, payment methods, and dates.') }}</p>
        ...
        <a href="{{ route('reports.expenses') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:border-rose-500 h-full flex flex-col">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-rose-600 transition-colors">{{ __('Expense Report') }}</h3>
                <p class="text-sm text-gray-500 flex-1">{{ __('Track gym expenditures by category, date, and view total expenses.') }}</p>
