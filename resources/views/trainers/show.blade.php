...
@section('meta_description', 'View trainer profile and assigned members.')
@section('page_title', 'Trainer Profile')
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
                ...
                <div class="w-full mt-6 pt-6 border-t border-gray-100 flex justify-around text-center">
                    <div>
                        ...
                        <p class="text-sm font-semibold mt-0.5" style="color:#374151;">{{ $trainer->joining_date->format('d M Y') }}</p>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <p class="text-xs font-medium" style="color:#9CA3AF;">Specialization</p>
                            <p class="text-sm font-semibold mt-1" style="color:#374151;">{{ $trainer->specialization ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium" style="color:#9CA3AF;">Salary / Rate</p>
                            <p class="text-sm font-semibold mt-1" style="color:#374151;">{{ $trainer->salary ? number_format($trainer->salary, 2) : 'N/A' }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium" style="color:#9CA3AF;">Date of Birth</p>
                            <p class="text-sm font-semibold mt-1" style="color:#374151;">{{ $trainer->date_of_birth ? $trainer->date_of_birth->format('d M Y') : 'N/A' }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium" style="color:#9CA3AF;">Members Assigned</p>
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <p class="text-xs font-medium mb-2" style="color:#9CA3AF;">Bio & Notes</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                @if($assignedMembers->isEmpty())
                    <div class="p-6 text-center">
                        ...
                        <p class="text-sm font-medium" style="color:#374151;">No members assigned</p>
                        <p class="text-xs mt-1" style="color:#6B7280;">Members can be linked to this trainer from their profile.</p>
                    </div>
                @else
